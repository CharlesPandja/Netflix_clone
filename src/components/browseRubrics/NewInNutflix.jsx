...
const NewInNutflix = () => {
    ...
    return (
        <div className="px-8 mt-8 mb-8">
            <h2 className="text-lg font-semibold text-white mb-3">Nouveautés sur Nutflix</h2>
                    ...
                    <SwiperSlide key={movie.id}>
                        <div className="relative">
                            <img
                                ...
                                loading="lazy"
                            />
                            <p className="absolute right-2 bottom-2 text-white text-sm p-2 bg-stone-950/40 rounded-lg">{movie.name}</p>
                        </div>
                    </SwiperSlide>
                ))}
            </Swiper>
