...
const Popcorn = () => {
    return (
        <>
            <div className="flex justify-center items-center gap-4 w-full px-30 bg-black">
                <img src={popcorn} className="w-30" alt="popcon image" />
                <div className='flex justify-between items-center p-4 mt-12 mb-12 bg-indigo-950 p-3 rounded-lg w-full'>
                    <div>
